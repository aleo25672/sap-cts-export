...
/**
 * Local stand-in for /sap/bc/zcts_extract so CTS_ADAPTER=http can be demoed
 * without a live SAP system. Same JSON contract as ZCL_CTS_EXTRACT_ICF.
 */
app.post("/sap/bc/zcts_extract", async (req, res) => {
  try {
...
app.get("/sap/bc/zcts_extract", async (req, res) => {
  try {
