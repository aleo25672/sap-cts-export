...
*&---------------------------------------------------------------------*
CLASS zcl_cts_extract_icf DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_cts_extract_icf IMPLEMENTATION.
